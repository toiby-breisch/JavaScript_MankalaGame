...
function allDisable() {
    for (let i = 0; i < 14; i++) {
        ...
        document.getElementById(i).setAttribute('style', 'pointer-events:none');
    }
}
...
async function moveMarbles(chosenHole) {
    allDisable();
    document.getElementById(chosenHole).style.border = "thick solid #FF0000";
    document.getElementById(chosenHole).style.borderRadius = "90%";
    document.getElementById(chosenHole).style.opacity = "0.5"
